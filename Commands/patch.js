...
module.exports = {
    ...
    run: function(bot, config, msg, args, suffix, Discord, color) {
        ...
        request.post({url:'https://mail.service.dc24.xyz/patch', headers: { 'Content-Type': 'multipart/form-data' }, formData: {uploaded_config: userConfig}}, function optionalCallback(err, httpResponse, body) {
              if (err) {
